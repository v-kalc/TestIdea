...
namespace Microsoft.Teams.Apps.SubmitIdea
{
    ...
    public static class ServicesExtension
    {
        ...
        public static void AddConfigurationSettings(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            string ideasTabEntityId = configuration.GetValue<string>("IdeasTabEntityId");

            services.Configure<SubmitIdeaActivityHandlerOptions>(options =>
            {
            ...
            services.Configure<BotSettings>(options =>
            {
                ...
                options.TeamId = ParseTeamIdFromDeepLink(configuration.GetValue<string>("App:TeamLink"));
            });
        ...
        public static void AddHelpers(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSingleton<ITeamIdeaStorageProvider, TeamIdeaStorageProvider>();
            ...
            services.AddSingleton<ITeamCategoryStorageHelper, TeamCategoryStorageHelper>();
            services.AddSingleton<ITeamCategoryStorageProvider, TeamCategoryStorageProvider>();

            services.AddSingleton<ITeamIdeaSearchService, TeamIdeaSearchService>();

            services.AddSingleton<IMessagingExtensionHelper, MessagingExtensionHelper>();
            services.AddSingleton<ITeamIdeaStorageHelper, TeamIdeaStorageHelper>();
            ...
            services.AddSingleton(new SearchIndexClient(configuration.GetValue<string>("SearchService:SearchServiceName"), TeamIdeaIndexName, new SearchCredentials(configuration.GetValue<string>("SearchService:SearchServiceQueryApiKey"))));
