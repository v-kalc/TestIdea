            ...
            IStringLocalizer<Strings> localizer)
        {
            AdaptiveCard card = new AdaptiveCard(new AdaptiveSchemaVersion(Constants.AdaptiveCardVersion))
            {
                Body = new List<AdaptiveElement>
                {
                        ...
                        Columns = new List<AdaptiveColumn>
                        {
                            new AdaptiveColumn
                            {
                                ...
                                Items = new List<AdaptiveElement>
                                {
                                    new AdaptiveImage
                                    {
                                        Url = new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/Artifacts/applicationLogo.png", applicationBasePath)),
                    ...
                    new AdaptiveTextBlock
                    {
                        Text = localizer.GetString("ViewIdeaBulletPoint"),
                        Wrap = true,
                        Spacing = AdaptiveSpacing.None,
                    },
                    new AdaptiveTextBlock
                ...
                Actions = new List<AdaptiveAction>
                {
                    new AdaptiveSubmitAction
                    {
                        ...
                        {
                            Msteams = new TaskModuleAction(Constants.SubmitAnIdeaAction, new { data = JsonConvert.SerializeObject(new AdaptiveTaskModuleCardAction { Text = Constants.SubmitAnIdeaAction }) }),
                        },
                    },
                },
            };
