...
namespace Microsoft.Teams.Apps.SubmitIdea.Common.Providers
{
    ...
    public class BaseStorageProvider
    {
        ...
        /// </summary>
        protected CloudTable SubmitIdeaCloudTable { get; set; }
        ...
        private async Task InitializeAsync()
        {
            try
            {
                ...
                this.SubmitIdeaCloudTable = cloudTableClient.GetTableReference(this.TableName);
                await this.SubmitIdeaCloudTable.CreateIfNotExistsAsync();
            }
            catch (Exception ex)
            {
