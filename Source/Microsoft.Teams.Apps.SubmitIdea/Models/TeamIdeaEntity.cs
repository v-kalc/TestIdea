// <copyright file="TeamIdeaEntity.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.SubmitIdea.Models
{
    ...
    /// </summary>
    public class TeamIdeaEntity : TableEntity
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamIdeaEntity"/> class.
        /// Holds team posts data.
        /// </summary>
        public TeamIdeaEntity()
        {
            this.PartitionKey = Constants.TeamIdeaEntityPartitionKey;
        }
        ...
        [IsFilterable]
        [IsSearchable]
        public string CreatedByUserPrincipleName { get; set; }
