...
/**
* Get idaa details
* @param ideaId Unique id of idea to get fetch data from Azure Table storage
*/
export const getIdea = async (ideaId: string): Promise<any> => {

    let url = `${baseAxiosUrl}/teamidea/idea?ideaId=${ideaId}`;
...
export const getAllIdeas = async (pageCount: number): Promise<any> => {
    ...
    let url = `${baseAxiosUrl}/teamidea?pageCount=${pageCount}`;
    return await axios.get(url);
}
...
export const getFilteredPosts = async (categories: string, sharedByNames: string, tags: string, sortBy: string, teamId: string, pageCount: number): Promise<any> => {
    let url = `${baseAxiosUrl}/teamidea/applied-filtered-team-posts?categories=${categories}&sharedByNames=${sharedByNames}
...
export const getCategories = async (): Promise<any> => {
    let url = `${baseAxiosUrl}/teamidea/unique-categories?searchText=*`;
    return await axios.get(url);
}
...
export const deletePost = async (post: any): Promise<any> => {
    ...
    let url = `${baseAxiosUrl}/teamidea?postId=${post.postId}&userId=${post.userId}`;
...
export const getAuthors = async (): Promise<any> => {
    ...
    let url = `${baseAxiosUrl}/teamidea/unique-user-names`;
    return await axios.get(url);
}
...
export const filterTitleAndTags = async (searchText: string, pageCount: number): Promise<any> => {
    let url = baseAxiosUrl + `/teamidea/search-team-posts?searchText=${searchText}&pageCount=${pageCount}`;
    return await axios.get(url);
}
...
export const filterTitleAndTagsTeam = async (searchText: string, teamId: string, pageCount: number): Promise<any> => {
    let url = baseAxiosUrl + `/teamidea/team-search-posts?searchText=${searchText}&teamId=${teamId}&pageCount=${pageCount}`;
    return await axios.get(url);
}
