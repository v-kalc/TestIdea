...
import { Text, Flex, Provider, Label, Input, AddIcon, Loader, Button, CloseIcon, Tooltip, InfoIcon, TextArea, Dropdown, TrashCanIcon, AcceptIcon } from "@fluentui/react-northstar";
    ...
    handleSubmit = () => {
        if (this.checkIfSubmitAllowed()) {
            ...
            let idea: IdeaEntity = {
                ...
                createdByUserPrincipleName: this.upn,
        ...
        if (!this.state.loading && !this.state.isIdeaSubmitedsuccessfully) {
            return (
                <Provider>
                    <div className="module-container">
                        <Flex column gap="gap.smaller" className="tab-container">
                            <Flex>
                                <NotificationMessage
                                ...
                                />
                                <Text content={this.localize("titleFormLabel")} />
                                <Flex.Item push>
                            ...
                            <Flex>
                                <Text content={this.localize("synopsisTitle")} />
                                <Flex.Item push>
                            ...
                            <div>
                                <Flex gap="gap.smaller" >
                                    <Text content={this.localize("tagsFormLabel")} /><Tooltip position="below" trigger={<InfoIcon outline className="info-icon" size="small" />} content={this.localize("tagInfo")} />
                                    <Flex.Item push>
                                        <div>
                                            {this.getTagError()}
                                        </div>
                            ...
                            <div>
                                <Flex gap="gap.smaller" >
                                    <Text content={this.localize("documentsFormLabel")} /><Tooltip position="below"
                                        trigger={<InfoIcon outline className="info-icon" size="small" />}
                                        content={this.localize("documentsFormLabel")} />
                                    <Flex.Item push>
                                        <div>
                                    ...
                                    <div className="document-text">
                                        {
                                            this.state.documentsList.map((value: string, index) => {
                                                if (value.trim().length > 0) {
                                                    return (
                                                        <Flex hAlign="center" key={index} gap="gap.smaller" className="margin-top-small">
                                                            <Text color="blue" className="document-hover" truncated content={value.trim()} />
                                                                <Flex.Item align="end" push>
                                                                    <TrashCanIcon styles={{ paddingRight: "0.5rem" }} className="hover-effect" onClick={() => this.onDocumentRemoveClick(index)} />
                                                                </Flex.Item>
                                                        </Flex>
                                                    )
                                                }
                    ...
                    <div className="tab-footer">
                        <Flex hAlign="end" ><Button primary content={this.localize("submitIdeaButtonText")}
            ...
            return (
                <div className="submit-idea-success-message-container">
                    ...
                    <div>
                        <AcceptIcon className="info-icon" size="large" />
                    </div>
