            ...
            <>
                <div className="tab-container">
                    <div>
                        ...
                        <Flex>
                            <Text content={t('categoryName')} size="medium" /><Text content="*" className="requiredfield" error size="medium" />
                            <Flex.Item push>
                    ...
                    <div>
                        <Flex>
                            <Text content={t('categoryDescription')} size="medium" /><Text content="*" className="requiredfield" error size="medium" />
                            <Flex.Item push>
