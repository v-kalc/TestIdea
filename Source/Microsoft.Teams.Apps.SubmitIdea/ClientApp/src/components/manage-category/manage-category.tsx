...
import { Loader, Flex, Text, Image, Layout, AcceptIcon, InfoIcon } from "@fluentui/react-northstar";
            ...
            return (
                <div className="module-container">
                    ...
                    {(this.state.showAddCategory === false && this.state.showEditCategory === false && !this.state.showDeleteCategory) &&
                        ...
                        <Flex>
                            {this.state.message !== undefined && <div style={{ marginLeft: "1rem"}}><AcceptIcon circular />
                                <Text content={this.state.message} success /></div>}
                                {this.state.categories.length > 0 && <Flex.Item push>
                                <Text align="end" content={t('lastUpdatedOn', {time: moment(new Date(this.state.categories[0].timestamp)).format("llll")})} />
                                </Flex.Item>}
                            </Flex></div>}
