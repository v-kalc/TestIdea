...
class ConfigurePreferences extends React.Component<IConfigurePreferencesProps, IConfigurePreferencesState> {
    ...
    constructor(props: any) {
        ...
        this.state = {
            allCategories: [],
            selectedDigestFrequency: this.localize("weeklyFrequencyText"),
            ...
            return (
                <div className="configure-preferences-div">
                    <Flex gap="gap.smaller" className="frequency-label">
                        <Text content={this.localize("digestFrequencyLabel")} />
                    </Flex>
                    ...
                    <Flex gap="gap.smaller" className="tag-searchbox-label">
                        <Text content={this.localize("categoriesLabel")} />
                        <Flex.Item push>
                    ...
                    <Flex vAlign="center">
                        <Flex.Item align="start" grow>
                            <Dropdown styles={{ marginTop: "0.5rem" }}
                    ...
                    <div className="tab-footer">
                        <Flex hAlign="end" ><Button primary loading={this.state.isSubmitLoading}
                            content={this.localize("Save")} disabled={this.state.isSubmitLoading}
                            onClick={this.onSubmitClick} /></Flex>
                    </div>
                </div>
